  ...
  methods: {
    fetchData() {
      getSetting().then(res=>{
        this.form = res.data;
        // 处理图片的链接
        this.form.avatar2 = process.env.VUE_APP_SEVER  + this.form.avatar;
        this.form.qqQrCode2 = process.env.VUE_APP_SEVER  + this.form.qqQrCode;
        this.form.weixinQrCode2 = process.env.VUE_APP_SEVER  + this.form.weixinQrCode;
